...
//   // filename: e.g. "lena256_encrypted_preview.tiff"
//   const baseName = filename.replace(/_encrypted_preview\.tiff$/i, "");
...
//     }
//     try {
//       // Directly send filename and key to decrypt endpoint
...
//       // Download decrypted TIFF
//       const blob = new Blob([decResp.data], { type: "image/tiff" });
//       const url = window.URL.createObjectURL(blob);
//       const link = document.createElement("a");
//       link.href = url;
//       link.setAttribute("download", `${baseName}_decrypted.tiff`);
...
//   const previewSrc = `http://localhost:8000/storage/preview/${baseName}_encrypted_preview.tiff`;
...
//       />
//       <div className="text-sm font-medium truncate mb-2">{filename}</div>
//       <input
//         type="text"
